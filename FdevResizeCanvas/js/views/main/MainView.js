...
], function(_, Backbone, Fabric, ObservableModel, CanvasObjectsModel, mainTemplate){
          ...
          if (el.target) {
              ...
              */
              ...
              if (el.target.name=='btnSpin'){
                ...
                if (randomNumber==1){
                  canvasModel.set('userBalance', balanceStart+userBet);
                  console.log('Ganaste:'+userBet+'!!! BALANCE: '+canvasModel.attributes.userBalance);
                } else {
                  canvasModel.set('userBalance', balanceStart-userBet);
                  console.log('Perdiste:'+userBet+' Intentalo de nuevo!!! BALANCE: '+canvasModel.attributes.userBalance);
                }
                var balanceStart = canvasModel.get('userBalance');
